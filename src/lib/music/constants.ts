...
// 도레미 음표 이름
export const SOLFEGE_NOTES: SolfegeNote[] = ['도', '레', '미', '파', '솔', '라', '시'];
...
// 각 음자리표별 기본 옥타브 범위
export const DEFAULT_OCTAVE_RANGES: Record<ClefType, { min: Octave; max: Octave }> = {
  treble: { min: 4, max: 6 },
  bass: { min: 2, max: 4 },
  alto: { min: 3, max: 5 },
  tenor: { min: 3, max: 5 }
...
export const DEFAULT_GAME_SETTINGS = {
  ...
  keySignature: 'C',
  octaveRange: { min: 4 as Octave, max: 6 as Octave },
