...
export default function EarTrainingPage() {
  ...
  return (
    <main className="app-shell">
      <div className="grid gap-3 xl:grid-cols-[300px_minmax(0,1fr)] xl:gap-5">
        <div className="order-2 space-y-3 xl:order-1 xl:space-y-5">
        ...
        <div className="order-1 space-y-3 xl:order-2 xl:space-y-5">
          <div className="rounded-[1.5rem] border border-[#ded6f7] bg-white p-3 shadow-[0_12px_32px_rgba(76,29,149,0.08)] sm:p-5">
            <div className="mb-3 flex flex-col gap-3 border-b border-[#ede9fe] pb-3 sm:mb-4 sm:flex-row sm:items-start sm:justify-between sm:pb-4">
              <div>
                <p className="text-sm font-bold uppercase tracking-[0.2em] text-[#6d28d9]">
                  {t.earTraining.subtitle}
                </p>
                <h1 className="mt-1 text-xl font-black tracking-[-0.04em] text-slate-950 sm:mt-2 sm:text-3xl">
            ...
            <div className="relative mt-3 rounded-[1.35rem] border border-[#ede9fe] bg-[#faf9fe] p-3 sm:mt-5 sm:rounded-[1.6rem] sm:p-5">
              {feedback && (
                <div
              ...
              <p className="mt-1 text-sm font-semibold text-slate-700 sm:mt-2 sm:pr-0 sm:text-lg">
                {sessionState === "playing"
                  ? t.earTraining.listenPrompt
                  : t.earTraining.start}
              </p>

              <div className="mt-3 rounded-[1.2rem] border border-[#ede9fe] bg-white p-2.5 sm:mt-5 sm:rounded-[1.3rem] sm:p-4">
                ...
                <div className="mt-2 sm:mt-4">
                  {settings.inputMode === "piano" ? (
                    <PianoKeyboard
                      ...
                      disabled={
                        sessionState !== "playing" || isAdvancingQuestion
                      }
          ...
          {result && <EarTrainingResult result={result} stats={stats} />}
        </div>
      </div>
    </main>
  );
