...
function formatPeriodDate(value: string | undefined, locale: string) {
          ...
          <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
            ...
            <div className="rounded-2xl border border-[#ded6f7] bg-white px-5 py-4 text-left shadow-[0_12px_35px_rgba(76,29,149,0.06)] md:text-right">
              <p className="text-xs font-bold uppercase tracking-[0.16em] text-slate-500">
                {t.leaderboard.accumulationPeriod}
              </p>
              <p className="mt-1 text-lg font-black text-slate-950">
                {formatPeriodDate(periodDate, language)} UTC
              </p>
              <p className="mt-1 text-sm text-slate-600">
                {t.leaderboard.scoresResetDaily}
              </p>
            </div>
          </div>
        </section>
